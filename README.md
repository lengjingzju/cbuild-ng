...
* Variables in `inc.rule.mk`
    ...
    * COMPILE_TOOL  : It provides the following compilation methods:
        ...
        * meson     : `meson` command will run before `MAKES` command, related variables:
            ...
            * MESON_LIBDIR      : Sets the libdir, its default value is `--libdir=$(INS_TOPDIR)$(INS_SUBDIR)/lib` (prevents native-build installing libraries to `xxx/lib/x86_64-linux-gnu/`)
<br>
