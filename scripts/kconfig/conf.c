...
static const struct option long_opts[] = {
	...
	{"rustccfgpath",  required_argument, &input_mode_opt, rustccfgpath},
	{NULL, 0, NULL, 0}
};
...
static void conf_usage(const char *progname)
{
	...
	printf("  --rustccfgpath          Specify the rustccfgpath path, default is 'include/generated/rustc_cfg'\n");
}
